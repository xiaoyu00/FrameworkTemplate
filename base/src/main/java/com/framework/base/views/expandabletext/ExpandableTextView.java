...
package com.framework.base.views.expandabletext;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        if (isInEditMode()) {
            ...
            mAnimationDuration = typedArray.getInt(R.styleable.ExpandableTextView_animationDuration, DEFAULT_ANIM_DURATION);
            ...
            contentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_contentTextColor, ContextCompat.getColor(getContext(), R.color.grey));
            contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, DensityUtils.INSTANCE.spTopx(getContext(),14));
            ...
            collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize, DensityUtils.INSTANCE.spTopx(getContext(),14));
