...
public class MoreLineTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void initWithAttrs(AttributeSet attrs) {
        if (isInEditMode()) {
            ...
            mTextColor = typedArray.getColor(R.styleable.MoreTextStyle_textColor, ContextCompat.getColor(getContext(), R.color.grey));
            mTextSize = typedArray.getDimension(R.styleable.MoreTextStyle_textSize, DensityUtils.INSTANCE.spTopx(getContext(),14));
