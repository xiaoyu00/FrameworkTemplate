package com.luck.picture.camerax.views;

import static com.luck.picture.camerax.FrameworkCameraView.BUTTON_STATE_BOTH;
import static com.luck.picture.camerax.FrameworkCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.luck.picture.camerax.FrameworkCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    public CaptureButton(Context context, int size) {
        ...
        Log.i("CaptureButton", "CaptureButtom start");
        duration = 10 * 1000;              //默认最长录制时间为10s
        Log.i("CaptureButton", "CaptureButtom end");
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.i("CaptureButton", "state = " + state);
